...
\title{Predicting Head Movement on Panoramic Video: \\A Deep Reinforcement Learning Approach}
%
%
...
\begin{figure*}
	\begin{center}
		\centerline{\includegraphics[width=1.5\columnwidth]{figures/dhp_approach/training_framework_2}}%of
