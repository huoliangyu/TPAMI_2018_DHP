...
\begin{figure*}
	\begin{center}
      ...
      \subfigure[]{\includegraphics[width=0.58\columnwidth]{figures/introduction/Head}}
		\subfigure[]{\includegraphics[width=1.36\columnwidth]{figures/introduction/fig_one}}
        \vspace{-.5em}
