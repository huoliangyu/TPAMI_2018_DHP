...
\begin{IEEEbiography}[{\includegraphics[width=1\linewidth]{mxu.eps}}]{Mai Xu}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{ZulinWang.eps}}]{Zulin~Wang}
